...
const ChallengeModal = ({
  ...
  return (
    <div
      ...
      className="fixed inset-0 z-[5000] flex justify-center items-start bg-black/90 backdrop-blur-md overflow-y-auto p-4 md:py-12"
    >
      {/* Container */}
      <div className="bg-[#0f121a] border border-emerald-500/20 w-full max-w-2xl my-8 rounded-[2.5rem] p-5 md:p-10 shadow-2xl relative flex flex-col max-h-[85vh]">
        <div className="overflow-y-auto pr-2 flex-1 custom-scrollbar">
          ...
          <div className="flex items-center gap-4 mb-8 mt-2 px-2">
            <div
              className={`h-1.5 flex-1 rounded-full transition-all duration-500 ${step >= 1 ? "bg-emerald-500 shadow-[0_0_10px_#10b981]" : "bg-gray-800"}`}
            ></div>
            <div
              className={`h-1.5 flex-1 rounded-full transition-all duration-500 ${step >= 2 ? "bg-emerald-500 shadow-[0_0_10px_#10b981]" : "bg-gray-800"}`}
            ></div>
          </div>
                    ...
                    <div className="p-4 md:p-5 bg-blue-500/5 border border-blue-500/10 rounded-[1.5rem] md:rounded-[2rem] space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        ...
                        <input
                          ...
                          className="w-full bg-black/40 border border-gray-800 rounded-xl px-4 py-3 text-sm text-white focus:border-blue-500 outline-none transition-all"
                          value={
                            formData.scenarioData?.userData?.birthYear || ""
                          }
                          onChange={(e) =>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            updateUserData("pet", e.target.value)
                          }
                        />
                      </div>
                      <input
                        ...
                        onChange={(e) =>
                          updateUserData("hobby", e.target.value)
                        }
                      />
                    </div>
                    ...
                    <div className="space-y-5 px-1">
                      ...
                      <div className="space-y-2 pb-6">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            updateScenario("hint", e.target.value)
                          }
                        />
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          value={
                            formData.scenarioData?.vulnerability_type || ""
                          }
                          onChange={(e) =>
                      ...
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            updateScenario("fix", e.target.value)
                          }
                        />
                      </div>
                      <div className="space-y-2">
                  ...
                  <div className="space-y-6 animate-in fade-in duration-500 max-h-[65vh] md:max-h-none overflow-y-auto pr-2 custom-scrollbar text-left pb-10">
                    ...
                    <div className="p-4 md:p-5 bg-emerald-500/5 border border-emerald-500/10 rounded-[1.5rem] md:rounded-[2rem] space-y-2">
                      ...
                      <textarea
                        ...
                        onChange={(e) =>
                          updateScenario("task", e.target.value.split("\n"))
                        }
                      />
                    </div>
                      ...
                      <div className="space-y-4">
                        {(formData.scenarioData?.dataItems || []).map(
                          (item, idx) => (
                            <div
                              key={item.id}
                              className="p-4 bg-white/5 border border-gray-800 rounded-2xl space-y-4 transition-all hover:border-gray-700"
                            >
                      ...
                      <div className="space-y-5">
                        {(formData.scenarioData?.questions || []).map(
                          (q, qIdx) => (
                            <div
                              key={q.id}
                              className="p-5 md:p-6 bg-white/5 border border-gray-800 rounded-[1.5rem] md:rounded-[2rem] space-y-4 relative transition-all hover:border-emerald-500/30"
                            >
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                {q.options.map((opt, optIdx) => (
                                  <div
                                    key={optIdx}
                                    className="flex items-center gap-3 bg-black/40 rounded-xl px-3 border border-gray-800 focus-within:border-emerald-500/50 transition-all"
                                  >
                                    <input
                                      type="radio"
                                      name={`correct-${q.id}`}
              ...
              {step === 1 ? (
                <>
                  <button
                    type="button"
                    onClick={onClose}
                    className="flex-1 py-4 text-gray-500 font-bold uppercase text-[9px] md:text-[10px]"
                  >
                    Cancel
                  </button>
                  <button
                ...
                <>
                  <button
                    type="button"
                    onClick={() => setStep(1)}
                    className="flex-1 py-4 text-gray-400 font-bold uppercase text-[9px] md:text-[10px]"
                  >
                    Go Back
                  </button>
                  <button
